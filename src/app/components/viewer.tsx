  ...
  return (
    <div className="flex flex-col gap-8 z-10">
      <p>
        ...
        <Link
          href="https://ngs24.ru/text/incidents/2023/08/30/72650588/"
          target="_blank"
          className="underline"
        >
      ...
      <p>
        Помимо всего прочего, Евгений был музыкантом: послушайте его альбом
        «Новомерье»{" "}
        <Link
      ...
      >
        <div className="rounded-2xl p-6 md:p-8 bg-#0b0b0b/15 backdrop-blur-md backdrop-saturate-50">
          <div className="md:text-[1vw] text-neutral-100 flex flex-col gap-8 z-10">
            ...
            <p>
              Помимо всего прочего, Евгений был музыкантом: послушайте его
              альбом «Новомерье»{" "}
              <Link
                href="https://vk.com/music/album/-2000172182_18172182_902a49336333445e90"
                target="_blank"
            ...
            <p>
              ...
              так и не увидел, уверен, он был бы в восторге. Тут еще{" "}
              <Link
                href="https://www.youtube.com/@%D0%95%D0%B2%D0%B3%D0%B5%D0%BD%D0%B8%D0%B9%D0%A1%D0%BE%D1%82%D0%BD%D0%B8%D0%BA%D0%BE%D0%B2-%D0%B14%D1%8A"
                target="_blank"
                className="underline"
